...
void checkUser() async {
  ...
  String _response = (sharedPreferences.getString("Shared Result") != null) as String;
  String response = (sharedPreferences.getString("Shared Password") != null) as String;
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<BonsoirBroadcastPackage>(create: (context) => BonsoirBroadcastPackage()),
        ChangeNotifierProvider<BonsoirDiscoveryPackage>(create: (context) => BonsoirDiscoveryPackage() ),
      ],
